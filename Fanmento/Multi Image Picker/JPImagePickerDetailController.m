...
- (void)prepareForImageNumber:(NSInteger)newImageNumber {
    ...
    if ([image isKindOfClass:[UIImage class]]) {
        ...
        self.previewImageView = [[VILoaderImageView alloc]init];
        __block UIImageView*imageViewBlock = self.previewImageView;
        [(VILoaderImageView*)self.previewImageView setImageWithURL:(NSString*)image placeholderImage:[UIImage imageNamed:@"bg_blank_for_pics.png"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType) {
