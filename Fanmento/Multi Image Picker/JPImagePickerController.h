 ...
 */
enum JPImagePickerControllerThumbnailSize {
	kJPImagePickerControllerThumbnailSizeWidth = 100,
	kJPImagePickerControllerThumbnailSizeHeight = 100
};
...
- (void)imagePicker:(JPImagePickerController *)picker didFinishPickingWithImageNumbers:(NSArray*)imageNumbers;
