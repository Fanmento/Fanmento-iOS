...
// Facebook
#define FB_APP_ID             @"395199007202207"
...
/*- (id)initWithCompletionCallback:(void)){
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    // message
        ...
        [_back setContentMode:UIViewContentModeScaleAspectFill];
...
- (void)actionSave{
    ...
    [self.facebook requestWithGraphPath:@"me/photos"
                          ...
                          andHttpMethod:@"POST"
                            andDelegate:self];
    [[FNMAppDelegate appDelegate] trackPageViewWithName:@"Facebook Post Success"];
}
...
- (void)createFbInstance{
    ...
    self.facebook = fb;
   [(FNMAppDelegate*)[[UIApplication sharedApplication] delegate] setFacebook:self.facebook];
    [fb release];
...
- (void)request:(FBRequest *)request didLoad:(id)result{
    ...
    // post
        ...
        if(postId){
            ...
            [[[[UIAlertView alloc]initWithTitle:@"Post Succeedeed" message:@"Your Fanmento photo was successfully posted to Facebook!" delegate:nil cancelButtonTitle:@"Okay." otherButtonTitles:nil]autorelease]show];
            [self actionCancel];
        }else{
            UIAlertView *alert = [[UIAlertView alloc] 
                                  initWithTitle:@""
